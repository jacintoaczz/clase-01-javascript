...
function comprarBoton(event) {
  ...
  if (itemsDelCarrito !== null) {
    ...
    // Solo se pueden escribir strings en el local storage, no objetos u arreglos
    // debido a esto, se usa el metodo stringify() para poder escribir dichos tipos
    // de datos (u objetos).
...
const deleteItem = (e, itemId) => {
  ...
  // Borramos el div que tiene el boton presionado
